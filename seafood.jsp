...
<head>
    ...
    <title>Seafood | GOOD to EAT</title>
</head>
...
<%
                        sql="SELECT * FROM `information` WHERE `Category`='Seafood'";
                        ResultSet rs_s=con.createStatement().executeQuery(sql);

                            while(rs_s.next()){
                            out.println("<div class='product0'>");
                            out.println("<form action='product.jsp'>");
                            out.println("<a href='product.jsp?pid="+rs_s.getString(1)+"' class='productlink'>");
                            out.println("<div class='productblock'>");
                            out.println("<div class='hidden'>");
                            out.println("<input type='image' src='"+rs_s.getString(8)+"' class='productimg1'>");
                            ...
                            out.println("</div>");
                            out.println("</div>");
                            out.println("<div class='producttext'>"+rs_s.getString(2)+"<br><br>NT$"+rs_s.getString(4)+"</div>");
                            out.println("<input type='hidden' name='pid' value='"+rs_s.getString(1)+"'>");
                            out.println("</div>");
                            out.println("</a>");
                            out.println("</form>");
                            ...
                            out.println("<input type='hidden' name='cartid' value='"+rs_s.getString(1)+"'>");
                            out.println("</form>");
                            out.println("</div>");
                            out.println("</div>");
                            out.println("</div>");
