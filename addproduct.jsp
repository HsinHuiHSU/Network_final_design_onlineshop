    ...
    <section class="member">
        ...
        <section class="member-right" id="member-order">
            <div class="member-data">
                ...
                <hr><br>
                <br>
                <form action="up_addproduct.jsp" method="GET">
                    <table class="admin">
                        <tr>
                    ...
                    <div class="button">
                        <a href="">
                            <div class="">
                                <input type="submit" class="but5" value="確認新增" style="height: 40px; width: 100px;">
                            </div>
                        </a>
                    </div>
                </form>
